...
class BackendConfig {
  ...
  static const String baseUrl =
      'https://auditory-checking.onrender.com'; // Physical device - your actual IP
  ...
  static String tapGameResultEndpoint(String childId) =>
      '$baseUrl/tap-game/result/$childId';

  // Benchmark Assessment endpoints
  static String get mchatQuestionsEndpoint =>
      '$baseUrl/api/benchmark/mchat/questions';
  static String get mchatSubmitEndpoint =>
      '$baseUrl/api/benchmark/mchat/submit';
  static String get mchatHistoryEndpoint =>
      '$baseUrl/api/benchmark/mchat/history';
  static String compareEndpoint(String childId) =>
      '$baseUrl/api/benchmark/compare?child_id=$childId';
  static String milestonesEndpoint(int ageMonths) =>
      '$baseUrl/api/benchmark/milestones?age_months=$ageMonths';
  static String get milestonesSubmitEndpoint =>
      '$baseUrl/api/benchmark/milestones/submit';
  static String get milestonesHistoryEndpoint =>
      '$baseUrl/api/benchmark/milestones/history';
