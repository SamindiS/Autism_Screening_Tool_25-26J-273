...
class _ChildParentDetailsPageState extends State<ChildParentDetailsPage>
  ...
  Widget _buildStepChip(
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        color:
            isActive ? const Color(0xFFBB8ED0) : Colors.white.withOpacity(0.9),
        borderRadius: BorderRadius.circular(999),
        border: Border.all(
          color: isActive ? const Color(0xFFBB8ED0) : Colors.grey[300]!,
        ),
        boxShadow: isActive
            ? [
                BoxShadow(
        ...
        children: [
          CircleAvatar(
            ...
            backgroundColor: isActive
                ? Colors.white
                : const Color(0xFFBB8ED0).withOpacity(0.1),
            child: Text(
              step,
              style: TextStyle(
                fontSize: 11,
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: isSelected ? const Color(0xFFBB8ED0) : Colors.grey[100],
              borderRadius: BorderRadius.circular(12),
              border: Border.all(
                color: isSelected ? const Color(0xFFBB8ED0) : Colors.grey[300]!,
  ...
  Widget _buildBenchmarkAssessmentsSection() {
    ...
    final childId =
        childName.isNotEmpty && age != null ? '${childName}_$age' : null;
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(20),
        border: Border.all(
            color: const Color(0xFF7132C1).withOpacity(0.3), width: 1.5),
        boxShadow: [
          BoxShadow(
            ...
            children: [
              Expanded(
                child: OutlinedButton.icon(
                  onPressed: () => _navigateTo(MchatPage(
              ...
              Expanded(
                child: OutlinedButton.icon(
                  onPressed: () => _navigateTo(MilestoneTrackerPage(
                      childName: childName.isEmpty ? null : childName,
                      childAge: age,
                      childId: childId)),
