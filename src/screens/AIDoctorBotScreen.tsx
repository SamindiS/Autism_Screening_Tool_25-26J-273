...
import { recordQuestionnaireCompletion } from '../utils/SessionRecorder';
...
const AIDoctorBotScreen: React.FC<AIDoctorBotScreenProps> = ({
  ...
  const frequencyOptions = [
    { text: t.aiBot.options.always, value: 5 },
    { text: t.aiBot.options.usually, value: 4 },
    { text: t.aiBot.options.sometimes, value: 3 },
    { text: t.aiBot.options.rarely, value: 2 },
    { text: t.aiBot.options.never, value: 1 },
  ];

  const routineChangeOptions = [
    { text: t.aiBot.options.adaptsEasily, value: 5 },
    { text: t.aiBot.options.needsTime, value: 4 },
    { text: t.aiBot.options.showsDistress, value: 3 },
    { text: t.aiBot.options.veryUpset, value: 2 },
    { text: t.aiBot.options.cannotAdapt, value: 1 },
  ];
  ...
  const completeAssessment = async () => {
    ...
    await recordQuestionnaireCompletion({
      child: child,
      responses: answers,
      summary: {
        totalScore: totalScore,
