...
Use two terminals from the **SenseAI** folder:

**Terminal 1 – backend**

```powershell
cd "d:\Documents\Visual attention & preferences New\Visual attention & preferences\SenseAI"
.\run_backend.ps1
```
...
This runs the app in **Chrome** by default (avoids Android/Kotlin path issues). To run on a connected phone instead:

```powershell
.\run_frontend.ps1 -Device
```
