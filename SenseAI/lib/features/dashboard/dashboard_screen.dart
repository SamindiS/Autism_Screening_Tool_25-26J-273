...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  Future<void> _loadData({bool isRefresh = false}) async {
    ...
    try {
      ...
      final children = childrenData.map((data) {
        ...
        final groupStr = data['study_group'] as String? ??
        ...
        return Child(
          ...
          dateOfBirth: dob,
          ageInMonths:
              data['age_in_months'] as int? ?? _calculateAgeInMonths(dob),
          ...
          asdLevel: data['asd_level'] != null
              ? AsdLevel.fromJson(data['asd_level'] as String)
              : null,
            ...
            ComponentTile(
              ...
              onTap: () async {
                await Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => const AuditoryResponseToNamePage(),
                  ),
                );
              },
            ),
            ComponentTile(
              ...
              onTap: () async {
                await Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => const visual_attention.SplashScreen(),
                  ),
                );
              },
            ),
  ...
  Widget _buildChildCard(Child child, bool isDark) {
    ...
    final primaryColor =
        isAsd ? const Color(0xFF6366F1) : const Color(0xFF10B981);
