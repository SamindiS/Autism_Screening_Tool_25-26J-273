...
const ResultScreen: React.FC<ResultScreenProps> = ({ navigation, route }) => {
  ...
  const MetricCard = ({ title, value, unit, color, icon }: { title: string; value: string; unit: string; color: string; icon: string }) => (
  ...
  const RiskIndicator = ({ riskLevel, confidence }: { riskLevel: 'low' | 'moderate' | 'high'; confidence: number }) => {
